            ...
            <form className="space-y-3" onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <FormField control={form.control}
                    ...
                    <FormItem>
                        ...
                        {field.value.map((item)=><div className='flex gap-1 flex-wrap '>
                            <div onClick={()=> handleTagsChange(item)}className='curosr-pointer flex rounded-full items-center border gap-2 py-1 px-4'>
                    ...
                    />
                <DialogClose>
                    {false?<div><p>You can create only 3 porject with free plan, 
